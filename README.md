...
# Shows the top 10 countries in a table with the most cases of COVID-19 - clicking on the row will show further details such as newly confirmed cases, new deaths, total deaths, newly recovered and total recovered for that country.

# Sourced from https://covid19api.com/ - https://github.com/CSSEGISandData/COVID-19 and based on https://github.com/atheodosiou/ng-bootstrap-table.

# Uses Angular and Bootstrap.
